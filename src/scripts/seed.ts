...
const MONGODB_URI =
  process.env["MONGODB_URI"] || "mongodb://localhost:27017/medicare_pro_db";
...
async function main() {
  ...
  try {
    ...
    const appointments = await Appointment.insertMany([
      ...
      // Test appointment for Razorpay testing
      {
        userId: user._id.toString(),
        doctorId: doctors[0]?._id.toString(),
        appointmentType: "consultation",
        ...
        status: "pending",
        symptoms: "Test appointment for payment testing",
        notes: "This is a test appointment for Razorpay integration testing",
        totalAmount: 100, // Fixed amount for testing
        paymentStatus: "pending",
      },
    ]);
